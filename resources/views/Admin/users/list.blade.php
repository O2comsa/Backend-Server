    ...
    <script type="text/javascript">
            ...
            swal.fire({
                ...
                if (e.value) {
                    ...
                    swal.fire({
                        ...
                        text: "{{ trans('app.delete_canceled') }}",
                        type: "error",
        ...
        $(document).on('change', '#changeStatus', function(e) {
            ...
            let spinner = Swal.fire({
                title: "{{ trans('app.Updating') }}",
                text: "{{ trans('app.Please wait...') }}",
            ...
            $.ajax({
                ...
                success: function(data) {
                    Swal.fire({
                        title: "{{ trans('app.Updated!') }}",
                        text: "{{ trans('app.Status has been updated.') }}",
                        icon: "success",
                        confirmButtonText: "{{ trans('app.ok') }}"
                    });

                    // Optionally, refresh status or table content here
                    $('#UsersTable').DataTable().ajax.reload();
                },
                error: function(xhr, status, error) {
                    Swal.fire({
                        title: "{{ trans('app.Error') }}",
                        text: "{{ trans('app.Something went wrong!') }}",
                        icon: "error",
                        confirmButtonText: "{{ trans('app.ok') }}"
                    });
                }
