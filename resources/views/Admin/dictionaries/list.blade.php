...
@section('page-title', trans('app.dictionaries'))
@section('page-heading', trans('app.dictionaries'))
        ...
        <div class="block block-rounded block-bordered">
            <div class="block-header block-header-default">
                ...
                <div class="col-md-3 ml-auto">
                    <a href="{{ route('dictionaries.create') }}" class="btn btn-primary">
                        @lang('app.add_dictionaries')
                    </a>
                </div>
            </div>
            <div class="block-content">
                <table class="table table-striped table-vcenter" id="dictionariesTable" style="width: 100%">
...
@section('js_after')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#dictionariesTable').DataTable({
                "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
                processing: true,
                serverSide: true,
                responsive: true,
                ajax: '{!! route('getDictionaries') !!}',
                columns: [
            ...
            swal.fire({
                ...
                if (e.value) {
                    $.ajax({
                        ...
                        type: "POST",
                        url: "{{route('dictionaries.destroy')}}",
                        data: {id: id},
