...
@section('page-title', trans('app.lessons'))
@section('page-heading', trans('app.lessons'))
    ...
    <div class="col-md-12">
        <div class="block block-rounded block-bordered">
            ...
            <div class="block-content">
                <table class="table table-striped table-vcenter" id="lessonsTable" style="width: 100%">
