...
@section('page-title', trans('app.live-support-request'))
@section('page-heading', trans('app.live-support-request'))

@section('breadcrumb')
    <li class="breadcrumb-item active" aria-current="page">
        <a class="link-fx" href="">@lang('app.live-support-request')</a>
    </li>
@endsection
...
{{--                    </a>--}}
            ...
            <div class="block-content">
                <table class="table table-striped table-vcenter" id="coursesTable" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <th>@lang('app.duration_live_support')</th>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#coursesTable').DataTable({
                ...
                serverSide: true,
                responsive: true,
                ajax: '{!! route('getLiveSupportRequest') !!}',
                columns: [
            ...
            swal.fire({
                ...
                if (e.value) {
                    $.ajax({
                        ...
                        type: "POST",
                        url: "{{route('live-support-request.destroy')}}",
                        data: {id: id},
