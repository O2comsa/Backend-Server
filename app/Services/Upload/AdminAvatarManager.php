...
class AdminAvatarManager
{
     ...
     */
    public function uploadAndCropAvatar(Admin $user, UploadedFile $file, array $cropPoints = null)
    {
     ...
     * @return bool
     */
    private function userHasUploadedAvatar(Admin $user)
    {
    ...
    {
        return public_path('upload/images/admin');
    }

    /**
     * @param Admin $user
     */
    public function deleteAvatarIfUploaded(Admin $user)
    {
    ...
    {
        return sprintf("%s.png", rand(0,9999999));
    }
